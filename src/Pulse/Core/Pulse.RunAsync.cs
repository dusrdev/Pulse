...
internal sealed partial class Pulse {
    ...
    public static async Task RunAsync(Parameters parameters, RequestDetails requestDetails) {
        ...
        var monitor = new Pulse(httpClient, requestDetails.Request, parameters);
        ...
        await PulseSummary.SummarizeAsync(parameters, requestDetails, result).ConfigureAwait(false);
    }
}